...
<head>
  ...
  <title>SIRaport | Edit Kelas</title>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="card-header">
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/proses_edit_kelas" method="POST">
                {{csrf_field()}}
                @foreach($hasil as $h)
                <input type="hidden" class="form-control" name="id_kelas" value="{{$h->id_kelas}}">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="wali_kelas" value="{{$h->wali_kelas}}" required>
                  </div>    
                  @endforeach            

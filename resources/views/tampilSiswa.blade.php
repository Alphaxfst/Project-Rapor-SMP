    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form action="/proses_search" method="POST" class="form-inline">
          {{csrf_field()}}
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <a href="/tambahsiswa" class="btn btn-md btn-primary mb-3">Tambah</a>
        <div class="card">
            ...
            <table id="example1" class="table table-bordered table-hover table-striped">
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="/editsiswa/{{$s->nis}}" class="btn btn-info btn-sm">
                      <span><i class="fa fa-edit"></i></span>
                  </a>
                  <a href="/deletesiswa/{{$s->nis}}" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin?')">

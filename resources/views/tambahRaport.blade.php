...
<head>
  ...
  <title>SiRaport | Tambah Raport</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tambah Raport</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        <div class="card">
          ...
          <div class="card-body">
            <div class="card-header">
              <!-- /.card-header -->
              <!-- form start -->
              <form action="proses_tambah_raport" method="POST">
                {{csrf_field()}}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kode_raport" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pkn" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ipa" required>
                  </div>
                  <div class="form-group">

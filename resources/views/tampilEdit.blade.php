...
<head>
  ...
  <title>SiRaport | Edit Siswa</title>
            ...
            <div class="card-header">
              ...
              <form action="/proses_edit" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Kelas</label>
                    <input type="text" class="form-control" name="nama_kelas" value="{{$h->nama_kelas}}" required>
                  </div>
                  <div class="form-group">
                    <label>No Telepon</label>
                    <input type="text" class="form-control" name="no_telp" value="{{$h->no_telp}}" required>
                  </div>
                  <div class="form-group">
                    <label>Alamat</label>
                    <input type="text" class="form-control" name="alamat" value="{{$h->alamat}}" required>
                  </div>
                  <div class="form-group">
                    <label>Wali Siswa</label>
                    <input type="text" class="form-control" name="wali_siswa" value="{{$h->wali_siswa}}" required>
                  </div>

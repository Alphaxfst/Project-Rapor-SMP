...
<head>
  ...
  <title>SIRaport | Identitas Sekolah</title>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Data Identitas Sekolah</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
          ...
          <div class="callout callout-warning">
            ...
            <p>Berikut adalah Informasi Sekolah</p>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table class="table table-bordered table table-hover table-striped mt-4">
                ...
                <tr class="text-center">
                  ...
                  <td>{{$i->kontak_sklh}}</td>
                  <td>
                    <a href="/editid/{{$i->id_sklh}}" class="btn btn-info btn-sm">
